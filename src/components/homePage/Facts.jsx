...
const Facts = () => {
  return (
    <div
      className="w-full min-h-screen  text-white bg-cover bg-center bg-[var(--primary-brown)] relative"
      ...
      <div className="flex justify-center items-center ">
        <div className="max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            ...
            <p className="text-sm md:text-lg font-semibold text-justify sm:text-center lg:text-left ">
          ...
          <div className="flex justify-center items-center">
            <img
              src={heroImage2}
              className="w-[300px] md:w-[400px] lg:w-[500px] object-cover md:mb-10 "
              alt=""
            />
          </div>
        </div>
