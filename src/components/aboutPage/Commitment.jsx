...
const Commitment = () => {
  return (
    <div className="w-full min-h-screen  bg-[var(--primary-yellow)]">
      ...
      >
        <h1 className="text-[var(--primary-dark)] mb-30 text-5xl md:text-6xl lg:text-7xl px-5">
          OUR COMMITMENT TO EXCELLENCE
        </h1>
        <div className="flex flex-wrap justify-center gap-x-30 gap-y-10 mb-10 ">
          <div className="w-[300px] md:w-[350px] shadow-xl bg-gray-100 flex flex-col p-5 rounded-lg hover:scale-105 duration-300 ">
            <img className="w-20 mx-auto mt-[-3rem] " src={Mission} alt="/" />
            <h1 className="text-3xl my-5">Mission</h1>

            <div className="text-justify  leading-relaxed px-5 text-sm sm:text-base">
              <p>
          ...
          <div className="w-[300px] md:w-[350px] xl:h-[400px] shadow-xl bg-[var(--primary-blue)] flex flex-col p-5  lg:my-20 rounded-lg hover:scale-105 duration-300 text-white ">
            <img className="w-20 mx-auto mt-[-3rem] " src={Vision} alt="/" />
            <h1 className="text-3xl my-5">Vision</h1>
            <p className="text-justify leading-relaxed px-5 text-sm sm:text-base">
